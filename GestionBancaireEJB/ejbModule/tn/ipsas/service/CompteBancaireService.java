...
public class CompteBancaireService implements CompteBancaireServiceLocal,
	...
	public ArrayList<CompteBancaireDTO> listDesComptes() {
		...
		ArrayList<CompteBancaireDTO> listdto = (ArrayList<CompteBancaireDTO>) CompteBancaireHelper
				.listModelToDto(listcb);
		return listdto;
	}
	...
	@Override
	public boolean listDesComptes(String cin) {
		boolean bool = true;
		ArrayList<CompteBancaire> listcb = null;
		listcb = dao.getByCin(cin);
		if (listcb != null)
			bool = false;
		return bool;
	}
