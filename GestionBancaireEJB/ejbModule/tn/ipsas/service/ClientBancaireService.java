...
public class ClientBancaireService implements ClientBancaireServiceLocal,
		ClientBancaireServiceRemote, ClientBancaireServiceWS {
	...
	public ArrayList<ClientBanqueDTO> listDesComptes() {
		...
		ArrayList<ClientBanqueDTO> listdto = (ArrayList<ClientBanqueDTO>) ClientBancaireHelper
